...
namespace Interactions
{
    public class Torch0 : NetworkPickableItem, IFireable
    {
        ...
        [Header("Model Stuff")]
        [SerializeField] Transform torchAnchor, torchWood;
        [SerializeField] FireCollision torchFireCollider;

        [Header("Fire Stuff")]
        [SerializeField] ParticleSystem flameVFX;
        [SerializeField] Transform flameBase, flameRed, flameOrange, flameYellow;
        [Space(5)]
        [SerializeField, Tooltip("Exponential Decay, for when the fire burns out")] 
        float flameDecayRate = -1.5f;
        [SerializeField, Tooltip("Exponential Decay, for when the fire burns out")] 
        float lightDecayRate = -.5f;
        ...
        private float maxTorchWoodScale,    torchWoodScale;
        private float maxFlameSize,         flameSize;
        private float maxLightIntensity,    lightIntensity = -1f;
